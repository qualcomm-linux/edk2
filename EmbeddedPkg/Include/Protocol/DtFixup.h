...
#define DT_FIXUP_PROTOCOL_REVISION  0x00000000

typedef struct _DT_FIXUP_PROTOCOL DT_FIXUP_PROTOCOL;

/* Flags */
#define DT_FIXUP_APPLY_FIXUPS    0x00000001  /* add nodes / props */
#define DT_FIXUP_RESERVE_MEMORY  0x00000002  /* honour /reserved-memory */
